...
data.forEach(l => {
    ...
    for (let t of tm) {
     ...
     list[l.CODE] = [l.CODE, l.CORS_NM, l.PROF_NM, l.SCH_YR, l.CREDIT, l.CORS_DIV_NM, l.LECT_DIV_NM, l.DEPT_NM, l.REQ_DEPT_NM, l.LECT_TM, l.LECT_RM ? [...new Set(l.LECT_RM.split(','))].join(',') : '', l.LECT_HR, l.CLS_CNT, timeString].map(e=>e?e:'');
});
let lecture = {
    list
};
